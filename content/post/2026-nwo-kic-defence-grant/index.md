...
The project aims to make the joining and repair of advanced lightweight composites more controllable and less dependent on extensive machinery. The team will develop a programmable joining layer in which magnetic nanoparticles generate heat when exposed to a high-frequency magnetic field.

By tuning the nanoparticles to the processing temperature of the thermoplastic, the material can limit its own heating once the target temperature is reached. The nanoparticles can also provide feedback about the processing conditions, enabling in-situ temperature monitoring during bonding.
