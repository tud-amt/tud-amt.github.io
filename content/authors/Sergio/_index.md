---
# Display name
title: Dr. Sergio R. Turteltaub

# Full name (for SEO)
first_name: Sergio
last_name: Turteltaub
...
organizations:
  - name: TU Delft, Faculty of Aerospace Engineering
    url: 'https://www.tudelft.nl/staff/s.r.turteltaub/'
...
social:
  - icon: envelope
    icon_pack: fas
    link: 'mailto:S.R.Turteltaub@tudelft.nl'
#  - icon: twitter
#    icon_pack: fab
...
#    link: https://scholar.google.com/citations?user=eAEBQvQAAAAJ&hl=en
  - icon: linkedin
    icon_pack: fab
    link: https://nl.linkedin.com/in/sergio-turteltaub-b6260732
