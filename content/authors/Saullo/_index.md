---
# Display name
title: Dr. Saullo Giovani Pereira Castro

# Full name (for SEO)
first_name: Saullo
last_name: Giovani Pereira Castro
...
social:
  - icon: envelope
    icon_pack: fas
    link: 'mailto:S.G.P.Castro@tudelft.nl'
#  - icon: twitter
#    icon_pack: fab
...
#    link: https://scholar.google.com/citations?user=eAEBQvQAAAAJ&hl=en
  - icon: linkedin
    icon_pack: fab
    link: https://nl.linkedin.com/in/saullocastro
