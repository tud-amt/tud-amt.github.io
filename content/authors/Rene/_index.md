---
# Display name
title: Prof.dr.ir. R.C. Alderliesten

# Full name (for SEO)
first_name: Rene
last_name: Alderliesten
...
organizations:
  - name: TU Delft, Faculty of Aerospace Engineering
    url: 'https://www.tudelft.nl/staff/r.c.alderliesten/'
...
social:
  - icon: envelope
    icon_pack: fas
    link: 'R.C.Alderliesten@tudelft.nl'
#  - icon: twitter
#    icon_pack: fab
...
#    link: https://scholar.google.com/citations?user=eAEBQvQAAAAJ&hl=en
  - icon: linkedin
    icon_pack: fab
    link: https://nl.linkedin.com/in/ren%C3%A9-alderliesten
